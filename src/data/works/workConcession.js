...
const workConcession = {
    ...
    more: true,
    image: concessionImage, // Assurez-vous que "concession" est correctement importé depuis '../assets/portfolio/miniatures/miniaCarte.png'
    actions: [{ id: 'concession_site', text: 'Visiter le site', link: 'http://lien-du-site.com', icon: 'Planet' }], // Remplacez par les actions appropriées
